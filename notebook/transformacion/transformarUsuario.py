...
def transformar_usuarios(de_usuarios_limpio):
    ...
    filtro1=df_usuarios_limpipo.query("edad > 25")
    ...
    filtro2=df_usuarios_limpipo.query("edad >= 19 and edad <= 30")
    ...
    filtro3=df_usuarios_limpipo.query("correo=correo")
    ...
    filtro4=df_usuarios_limpipo.query("contraseña.str.contains('admin')")
    ...
    filtro5=df_usuarios_limpipo.query("edad < 40")
